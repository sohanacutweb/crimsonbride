...
function flatsome_share($atts, $content = null) {
	...
	<div class="<?php echo implode(' ', $wrapper_class); ?>" <?php echo $scale;?>>
		  ...
		  <a href="whatsapp://send?text=<?php echo $whatsapp_text; ?>" data-action="share/whatsapp/share" class="<?php echo $classes;?> whatsapp show-for-medium" title="<?php _e('Share on WhatsApp','flatsome'); ?>"><i class="fa fa-whatsapp fa-2x" aria-hidden="true"></i></a>
